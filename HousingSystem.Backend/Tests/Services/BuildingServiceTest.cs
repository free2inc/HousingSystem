...
namespace HousingSystem.Tests.Services
{
    public class BuildingServiceTest
    {
        ...
        //{
        //    //Arrange
        //    var apartmentServiceMock = new Mock<IRepository<Apartment>>();
        ...
        //        Number = "Number"
        //    };
        //    buildingRepositoryMock.Setup(setup => setup.Create(testBuilding)).Returns(testBuilding.CityAdminBuildingId);

        //    var service = new BuildingService(buildingRepositoryMock.Object, logMock.Object, apartmentServiceMock.Object);



        //    //Act
        //   service.CreateBuilding(testBuilding);

        //    // Assert
        //    //Assert.Equal("", result?.ViewData["Message"]);
        //    Assert.Equal("", ""/* ViewData["Message"]*/);
        //}


        [Fact]
        public void GetBuilding_ReturnNotNull()
        {
            var building = CreateBuildings()[0];
            _buildingRepositoryMock.Setup(repo => repo.Get(building.Id)).Returns(building);

            var result = _buildingService.GetBuilding(building.Id);
